...
module.exports = {
  ...
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ...
    ['meta', { name: 'referrer', content: 'no-referrer-when-downgrade' }], // 解决Chrome统计不准确
    ['link', { rel: 'stylesheet', href: 'https://at.alicdn.com/t/font_3077305_pt8umhrn4k9.css' }] // 在线矢量图
  ],
  ...
  themeConfig: {
    ...
    repo: 'xiangxu999/wxx-blog', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: '旭日', // 必需
      href: 'https://github.com/xiangxu999' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:wen_xiangxu@outlook.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/xiangxu999'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/#/user/home?id=1794334627'
        }
      ]
    },
    footer: { // 页脚信息
